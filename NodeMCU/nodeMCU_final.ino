...
int seconds_clr[3] = {0, 255, 0};  // green
int mins_clr[3] = {255, 0, 0};     // red
int hours_clr[3] = {0, 0, 255};    // blue

// int seconds_clr[3] = {153, 0, 153};  // UCU purple
// int mins_clr[3] = {0, 255, 0};       // UCU green
// int hours_clr[3] = {153, 0, 153};    // UCU purple
...
void setup()
{
  ...
  Serial.begin(7200); // UTC+2 -> 2 * 60 * 60
  Wire.begin(4, 5);
